...
class Interceptor extends \Magento\AdobeIoEventsClient\Console\SynchronizeEventMetadata implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\AdobeIoEventsClient\Api\EventMetadataRegistryInterface $eventRegistry, \Magento\AdobeIoEventsClient\Model\AdobeIOConfigurationProvider $configurationProvider, \Magento\AdobeIoEventsClient\Model\IOEventsAPIClient $IOEventsAPIClient)
    {
        $this->___init();
        parent::__construct($eventRegistry, $configurationProvider, $IOEventsAPIClient);
    }
